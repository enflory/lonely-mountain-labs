...
const FEATURED: Project[] = [
  ...
  },
  {
    ...
    description:
      "One device that boils water for dinner in the backcountry and charges the phone, so the stove and the power bank stop being two things to carry, and the last fossil fuel leaves the pack. Step one was the unglamorous question: does the physics work, and does the cost? Several weeks of modeling say a qualified yes, and turned up one finding that reorganized the entire design. Prototype is specified and next. The name? Sindarin for fire.",
    status: "Research",
    links: [],
    visual: "heat",
    year: "2026",
